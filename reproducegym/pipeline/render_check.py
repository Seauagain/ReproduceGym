...
The recompute logic is the single engine in reproducegym/verifier/engine.py, embedded
...
import reproducegym.verifier.engine as _engine
from reproducegym.pipeline.render_task import derive_contract
...
_ENGINE_BEGIN = "# === REPRODUCEGYM ENGINE BEGIN ==="
_ENGINE_END = "# === REPRODUCEGYM ENGINE END ==="

_HEADER = (
    "#!/usr/bin/env python3\n"
    '"""ReproduceGym recompute verifier (auto-generated).\n'
    "\n"
