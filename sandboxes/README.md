...
Flow: `extract_claims` + `extract_figure_params` → `triage` (paper_triage.yaml,
resource_profile.yaml) → `merge_claim_spec` → `claims/<id>.yaml` (source) →
