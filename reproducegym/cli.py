"""Command-line entry point.
    ...
    reproducegym reproduce <paper.md|pdf> [--claim ID]   # 1-8 end-to-end
    reproducegym build     <paper.md|pdf> [--claim ID]   # pipeline only (no run)
    reproducegym parse     <paper.pdf> -o <out>          # MinerU PDF -> paper.md
