...
targets)}. Exposure routing decides visible vs hidden per leaf (see
schema/task_contract.md). reward/check.py is NOT written here; it is authored by
the build-task skill. Stub only.
"""
